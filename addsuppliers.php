...
<body id="page-top" onload="clearTextBoxes()">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h2 mb-0" style = "color:#000;font-family: 'Impact', sans-serif;letter-spacing: 1px;">Add new supplier</h1>
                    </div>
                        ...
                        <div class="card-body" id='invoice'>
                            <div class="">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col">
                                        <label for="scompany">Supplier Company</label>
                                        <input type="text" class="form-control" id="scompany" name = "scompany" placeholder="Supplier Company" required>
                                    </div>
                                    <div class="form-group col">
